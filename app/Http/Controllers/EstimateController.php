       ...
       public function convertToPdf(Estimate $estimate)
{
    ...
    // Get branch details (needed for dynamic footer)
    ...
    <header style="width: 100%; height: 110px;">
        ...
        <div class="content-header" style="width: 100%; height: 1.80cm; margin: 0; position: relative;">
            ...
            <div class="content_header_title" style="vertical-align: middle; margin-top: 10px; float: left; display: inline-block; width: 31%; height: 1.13cm; text-align: center; line-height: 40px; border: 1px solid #bbdefb; background: #e3f2fd;">
