    ...
    <head>
        ...
        <head>
            <style>
                ...
                .bColor {
                    border: .05cm solid #bbdefb !important;
                }
            ...
            <div class="content_info">
                <table cellspacing="0" style="width: 100%; border-collapse: collapse;font-size:11px;line-height:9px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 3cm;">{{ isset($estimate->estimate_expiry_date) ? \Carbon\Carbon::parse($estimate->estimate_expiry_date)->format('d-m-Y') : 'N/A' }}
                        </td>
