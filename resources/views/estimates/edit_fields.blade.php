...
<div class="card-body">
    ...
    <div class="input-group">
        ...
        {{ Form::text(
            'estimate_date',
            \Carbon\Carbon::parse($estimate->estimate_date)->format('d-m-Y') ? \Carbon\Carbon::parse($estimate->estimate_date)->format('d-m-Y') : null,
    ...
    <div class="input-group">
        ...
        {{ Form::text(
            ...
            $estimate->estimate_expiry_date ? \Carbon\Carbon::parse($estimate->estimate_expiry_date)->format('d-m-Y') : null,
            ['class' => 'form-control due-datepicker', 'autocomplete' => 'off']
        ) }}
    </div>
</div>
        {{-- <div class="form-group col-lg-4 col-md-4 col-sm-12">
