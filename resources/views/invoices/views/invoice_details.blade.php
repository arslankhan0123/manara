    ...
    <table class="table table-bordered text-center">
        <thead>
            <tr style="background:lightblue;color:black;">
                ...
                <th class="text-center">Allowance Deduction</th>
                <th class="text-center">Damage Deduction</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center round-off-column">{{ number_format($invoice->adjustment ?? 0, 2) }}</td>
                <td class="text-center">{{ number_format((($totalTaxable ?? 0) + ($totalVat ?? 0) + ($invoice->adjustment ?? 0)), 2) }}</td>
            </tr>
        </tbody>
    </table>
</div>
