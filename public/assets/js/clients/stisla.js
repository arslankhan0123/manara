...
/***/ "./resources/assets/js/clients/stisla.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/clients/stisla.js ***!
  \***********************************************/
/***/ (function() {
...
(function ($, window, i) {
  ...
  $.chatCtrl = function (element, chat) {
    ...
    var target = $(element),
        element = '<div class="chat-item display-none' + chat.position + ' " >' + '<img src="' + chat.picture + '">' + '<div class="chat-details">' + '<div class="chat-text">' + chat.text + '</div>' + '<div class="chat-time">' + chat.time + '</div>' + '</div>' + '</div>',
        typing_element = '<div class="chat-item chat-left chat-typing display-none" >' + '<img src="' + chat.picture + '">' + '<div class="chat-details">' + '<div class="chat-text"></div>' + '</div>' + '</div>';
...
/******/ 	__webpack_modules__["./resources/assets/js/clients/stisla.js"]();
/******/ 	
/******/ })()
;