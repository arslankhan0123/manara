<div class="row">
    ...
    <div class="form-group col-sm-3">
      ...
      <div class="form-group col-sm-3">
        {{ Form::label('employee_code_prefix', 'Employee Code Prefix') }}
        {{ Form::text('employee_code_prefix', $settings['employee_code_prefix'] ?? '', [
            'class' => 'form-control',
        ]) }}
    </div>
    ...
    <div class="form-group col-sm-3">
        {{ Form::label('session_timeout', 'Session Timeout (Minutes):') }}<span class="required">*</span>
        {{ Form::number('session_timeout', $settings['session_timeout'] ?? 30, ['class' => 'form-control', 'required', 'min' => '1']) }}
    </div>
    <div class="form-group col-sm-3">
