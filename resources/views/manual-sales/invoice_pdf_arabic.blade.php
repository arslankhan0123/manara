    ...
    <main>
        <div class="content_info">
            ...
            <table id="invoiceSummaryTable" border="1" cellspacing="0" cellpadding="5"
                ...
                <tr>
                    ...
                    <td class="invoice-summary-value" bgcolor="#ffffff" colspan="2" style="background-color: #ffffff !important;">{!! $projectName !!}</td>
                    <td class="invoice-summary-key" colspan="1">Project Location<br>موقع المشروع</td>
                    <td class="invoice-summary-value" bgcolor="#ffffff" colspan="2" style="background-color: #ffffff !important;">{{ $projectLocation }}</td>
                </tr>
                <tr>
                    <td class="invoice-summary-key" colspan="1">P.O. No<br>أمر الشراء</td>
                    <td class="invoice-summary-value" bgcolor="#ffffff" colspan="3" style="background-color: #ffffff !important;">{{ $poNumber }}</td>
                    <td class="invoice-summary-key" colspan="1">Vendor Code<br>رمز المورد</td>
                    <td class="invoice-summary-value" bgcolor="#ffffff" colspan="3" style="background-color: #ffffff !important;">{{ $vendorCode }}</td>
            ...
            <table border="1" cellspacing="0" cellpadding="5"
                ...
                <tr>
                    ...
                    <td
                        ...
                        {{ $invoice->customer->vat_number ?? 'N/A' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width:2cm; word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">
                        {{ $invoice->customer->email ?? 'N/A' }}</td>

                </tr>
                <tr>
                    <td>P.O. No <br>أمر الشراء</td>
                    <td>{{ $poNumber }}</td>
                    <td>P.O. Date <br> تاريخ أمر الشراء</td>
                    <td>N/A</td>
                ...
                <tr>
                    ...
                    <td colspan="3">{{ $invoice->admin_text ?? 'N/A' }}</td>
                    <td>Branch<br>فرع</td>
                                ...
                                <td
                                    ...
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 70%; border-right: 1px solid {{ $bColor }};">
                                                <table style="width: 100%; border-collapse: collapse;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="width: 70%; padding: 4px; border-bottom: 1px solid {{ $bColor }};">
                                                            {{ $invoice->branch?->bank?->account_number ?? '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <!-- Row 3 -->
                                            ...
                                            <!-- Middle column: 1px wide -->
                                            <td style="width: 1px;"></td>

                                            <!-- Right side: 30% width (QR Code) -->
                                            <td style="width: 30%; ">
                                                @php
                                                ...
                                                @endphp
                                                @if ($qr_code && $invoice->payment_status != 0)
        ...
        <div style="font-family: Arial, sans-serif; clear: both;font-size:10pt;">
            @php
                ...
                } elseif (isset($invoice->terms) && $invoice->terms && $invoice->terms->isNotEmpty()) {
                    $terms = $invoice->terms;
                }
            @endphp
            @if ($terms)
