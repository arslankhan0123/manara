                                ...
                                <table class="table table-bordered tableVatReport">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?= number_format($invoice->amount+$invoice->totalVatAmount, 2) ?>
                                            </td>
                                            <td class="text-right">
                                                 <a href="<?= route('expenses.show', $invoice->id) ?>" target="_blank" class="btn btn-info">View</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td class="text-right"><?= number_format($purchase->excludingVatAmount, 2) ?></td>
                                            <td class="text-right"><?= number_format($purchase->totalVatAmount, 2) ?></td>
                                            <td class="text-right"><?= number_format($purchase->includingVatAmount, 2) ?></td>
                                            <td class="text-right">
                                                <a href="<?= route('purchase-invoices.view', $purchase->id) ?>" target="_blank"
                                                    class="btn btn-info">View</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td class="text-right"><?= number_format($purchaseReturn->excludingVatAmount, 2) ?></td>
                                            <td class="text-right"><?= number_format($purchaseReturn->totalVatAmount, 2) ?></td>
                                            <td class="text-right"><?= number_format($purchaseReturn->includingVatAmount, 2) ?></td>
                                            <td class="text-right">
                                                <a href="<?= route('purchase-returns.view', $purchaseReturn->id) ?>" target="_blank"
                                                    class="btn btn-info">View</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                ...
                                <table class="table table-bordered " id="allDataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?= number_format($expense->amount+$expense->totalVatAmount, 2) ?>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="markItemCheckbox"
                                                    name='purchaseReturn[{{ $purchaseReturn->id }}]' value="{{ $purchaseReturn->id }}">
                                            </td>
                                            <td><?= $purchaseReturn->return_number ?></td>
                                            <td><?= \Carbon\Carbon::parse($purchaseReturn->created_at)->format('d-m-Y') ?></td>
                                            <td>Purchase Return</td>
