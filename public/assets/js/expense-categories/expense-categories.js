...
/*!**********************************************************************!*\
  !*** ./resources/assets/js/expense-categories/expense-categories.js ***!
  \**********************************************************************/


alert("works fine");
var tableName = '#expenseCategoriesTable';
$(tableName).DataTable({
  oLanguage: {
...
$(document).on('click', '.edit-btn', function (event) {
  var expenseCategoryId = $(event.currentTarget).data('id');
...
$(document).on('click', '.delete-btn', function (event) {
  var expenseCategoryId = $(event.currentTarget).data('id');
  deleteItem(route('expense-categories.destroy', expenseCategoryId), '#expenseCategoriesTable', Lang.get('messages.common.expense_category'));
});
