...
/*!************************************************************!*\
  !*** ./resources/assets/js/lead-statuses/lead-statuses.js ***!
  \************************************************************/


var tableName = '#leadStatusTbl';
$(tableName).DataTable({
  oLanguage: {
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      if (row.color == null) return 'N/A';else return prepareTemplateRender('#leadStatusColorBox', data);
    },
    name: 'color'
  }, {
    data: 'order',
...
pickr.on('change', function () {
  ...
  if (wc_hex_is_light(color)) {
    $('#validationErrorsForColor').addClass('d-block').text('Pick a different color');
...
editPickr.on('change', function () {
  ...
  if (wc_hex_is_light(editColor)) {
    $('#editValidationErrorsForColor').addClass('d-block').text('Pick a different color');
...
$(document).on('click', '.edit-btn', function (event) {
  var leadStatusId = $(event.currentTarget).data('id');
...
$(document).on('click', '.delete-btn', function (event) {
  var leadStatusId = $(event.currentTarget).data('id');
  deleteItem(route('lead.status.destroy', leadStatusId), '#leadStatusTbl', Lang.get('messages.lead_status.lead_status'));
});
