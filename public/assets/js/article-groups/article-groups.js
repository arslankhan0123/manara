...
/*!**************************************************************!*\
  !*** ./resources/assets/js/article-groups/article-groups.js ***!
  \**************************************************************/


var tableName = '#articleGroupsTable';
$(tableName).DataTable({
  oLanguage: {
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#articleGroupActionTemplate', data);
    },
    name: 'id'
  }]
});
...
pickr.on('change', function () {
  ...
  if (wc_hex_is_light(color)) {
    $('#validationErrorsBoxForColor').addClass('d-block').text('Pick a different color');
...
$(document).on('click', '.edit-btn', function (event) {
  var articleGroupId = $(event.currentTarget).data('id');
...
$(document).on('click', '.delete-btn', function (event) {
  var articleGroupId = $(event.currentTarget).data('id');
  deleteItem(route('article-groups.destroy', articleGroupId), '#articleGroupsTable', Lang.get('messages.common.article_group'));
});
