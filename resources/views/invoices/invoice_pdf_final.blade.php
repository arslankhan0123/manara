                    ...
                    <tbody>
                        ...
                        @foreach ($invoice->salesItems as $index => $item)
                            @php
                                ...
                                $vatAmount = $taxableAmount * ($item->tax / 100);
                                $includingVat = $taxableAmount + $vatAmount;
                            @endphp
                            <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 25%; vertical-align: top;">
                            <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                                ...
                                <tr>
                                    <th class="font-weight-bold"
                                        style="border: 1px solid #848484; padding: 5px; text-align: right;">Deductions
                                    </th>
                                    <td class="text-right p-1"
                                        style="border: 1px solid #848484; padding: 5px; text-align: right;">
                                        {{ number_format($totalDeductions ?? 0, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold"
                                        style="border: 1px solid #848484; padding: 5px; text-align: right;">
